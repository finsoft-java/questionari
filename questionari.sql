...
--
-- Host: 127.0.0.1
-- Creato il: Set 03, 2019 alle 15:32
...
CREATE TABLE `domande` (
  ...
  `html_maxlength` int(10) DEFAULT NULL,
...
INSERT INTO `domande` (`id_questionario`, `progressivo_sezione`, `progressivo_domanda`, `descrizione`, `obbligatorieta`, `coeff_valutazione`, `html_type`, `html_pattern`, `html_min`, `html_max`, `html_maxlength`, `rimescola`) VALUES
...
(5, 1, 1, 'Era tutto buono?', '1', 1, NULL, NULL, NULL, NULL, NULL, '0'),
(5, 1, 2, 'Hai dei consigli?', '1', 1, '0', NULL, NULL, NULL, NULL, '0'),
(5, 2, 1, 'Quanto valuti l\'organizzazione da 1 a 5?', '1', 1, NULL, NULL, NULL, NULL, NULL, '0'),
(5, 3, 1, 'Era tutto buono?', '1', 1, NULL, NULL, NULL, NULL, NULL, '0'),
(5, 3, 2, 'Hai dei consigli?', '1', 1, '0', NULL, NULL, NULL, NULL, '0');
...
(2, 'Nuovo questionario 123', '0', '0', '0', 'finsoft', '2019-09-02 12:13:06'),
(4, 'Nuovo questionario 123', '0', '0', '0', 'finsoft', '2019-09-02 14:07:22'),
(5, 'Verifica post-festa', '0', '0', '0', 'finsoft', '2019-09-02 14:11:59');
...
CREATE TABLE `questionari_compilati` (
  ...
  `utente_valutato_corrente` varchar(255) DEFAULT NULL,
  `progr_sezione_corrente` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `questionari_compilati` (`progressivo_quest_comp`, `id_progetto`, `id_questionario`, `stato`, `utente_compilazione`, `data_compilazione`, `utente_valutato_corrente`, `progr_sezione_corrente`) VALUES
(3, 2, 1, '0', 'ale.b', '2019-07-05 08:36:10', NULL, NULL),
(10, 2, 1, '2', 'finsoft', '2019-07-24 08:23:39', NULL, NULL),
(11, 2, 1, '0', 'finsoft', '2019-08-30 17:35:20', NULL, NULL);
...
(5, 1, 1, 1, 'Sì', 1),
(5, 1, 1, 2, 'No', 0),
(5, 2, 1, 1, 'insufficiente', 1),
(5, 2, 1, 2, 'scarso', 2),
(5, 2, 1, 3, 'sufficiente', 3),
(5, 2, 1, 4, 'buono', 4),
(5, 2, 1, 5, 'ottimo', 5),
(5, 3, 1, 1, 'Sì', 1),
(5, 3, 1, 2, 'No', 0);
...
CREATE TABLE `risposte_quest_compilati` (
  ...
  `risposta_aperta` varchar(2000) DEFAULT NULL,
...
INSERT INTO `risposte_quest_compilati` (`progressivo_quest_comp`, `progressivo_sezione`, `progressivo_domanda`, `nome_utente_valutato`, `progressivo_risposta`, `risposta_aperta`, `note`) VALUES
(3, 1, 1, 'luca.vercelli', NULL, NULL, NULL),
(3, 1, 2, 'luca.vercelli', NULL, NULL, NULL),
(3, 2, 1, 'luca.vercelli', NULL, NULL, NULL),
(3, 3, 1, 'luca.vercelli', NULL, NULL, NULL),
(3, 3, 2, 'luca.vercelli', NULL, NULL, NULL),
(10, 1, 1, 'ale.b', NULL, NULL, NULL),
(10, 1, 1, 'finsoft', NULL, NULL, NULL),
(10, 1, 1, 'luca.vercelli', NULL, NULL, NULL),
(10, 1, 2, 'ale.b', NULL, NULL, NULL),
(10, 1, 2, 'finsoft', NULL, NULL, NULL),
(10, 1, 2, 'luca.vercelli', NULL, NULL, NULL),
(10, 2, 1, 'ale.b', NULL, NULL, NULL),
(10, 2, 1, 'finsoft', NULL, NULL, NULL),
(10, 2, 1, 'luca.vercelli', NULL, NULL, NULL),
(10, 3, 1, 'ale.b', NULL, NULL, NULL),
(10, 3, 1, 'finsoft', NULL, NULL, NULL),
(10, 3, 1, 'luca.vercelli', NULL, NULL, NULL),
(10, 3, 2, 'ale.b', NULL, NULL, NULL),
(10, 3, 2, 'finsoft', NULL, NULL, NULL),
(10, 3, 2, 'luca.vercelli', NULL, NULL, NULL),
(11, 1, 1, 'luca.vercelli', 1, NULL, NULL),
(11, 1, 2, 'luca.vercelli', NULL, 'no', NULL),
(11, 2, 1, 'luca.vercelli', NULL, NULL, NULL),
(11, 3, 1, 'luca.vercelli', NULL, NULL, NULL),
(11, 3, 2, 'luca.vercelli', NULL, NULL, NULL);
...
--
-- Struttura stand-in per le viste `v_questionari_storici_per_utente`
-- (Vedi sotto per la vista effettiva)
--
CREATE TABLE `v_questionari_storici_per_utente` (
`id_progetto` int(10)
,`titolo_progetto` varchar(500)
,`stato_progetto` varchar(1)
,`id_questionario` int(10)
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_progetti_questionari_utenti`  AS  select `p`.`id_progetto` AS `id_progetto`,`p`.`titolo` AS `titolo_progetto`,`p`.`stato` AS `stato_progetto`,`p`.`utente_creazione` AS `ut_creaz_progetto`,`p`.`data_creazione` AS `data_creaz_progetto`,`q`.`id_questionario` AS `id_questionario`,`q`.`titolo` AS `titolo_questionario`,`q`.`stato` AS `stato_questionario`,`q`.`flag_comune` AS `flag_comune`,`q`.`utente_creazione` AS `ut_creaz_questionario`,`q`.`data_creazione` AS `data_creaz_questionario`,`x`.`tipo_questionario` AS `tipo_questionario`,`x`.`gruppo_compilanti` AS `gruppo_compilanti`,`x`.`gruppo_valutati` AS `gruppo_valutati`,`x`.`autovalutazione` AS `autovalutazione`,`u`.`nome_utente` AS `nome_utente`,`u`.`funzione` AS `funzione`,`ux`.`nome` AS `nome`,`ux`.`cognome` AS `cognome` from ((((`progetti` `p` join `progetti_questionari` `x` on(`x`.`id_progetto` = `p`.`id_progetto`)) join `progetti_utenti` `u` on(`u`.`id_progetto` = `p`.`id_progetto`)) join `questionari` `q` on(`q`.`id_questionario` = `x`.`id_questionario`)) join `utenti` `ux` on(`ux`.`username` = `u`.`nome_utente`)) ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_questionari_compilabili_per_utente`  AS  select `p`.`id_progetto` AS `id_progetto`,`p`.`titolo` AS `titolo_progetto`,`p`.`stato` AS `stato_progetto`,`q`.`id_questionario` AS `id_questionario`,`q`.`titolo` AS `titolo_questionario`,`q`.`stato` AS `stato_questionario`,`x`.`tipo_questionario` AS `tipo_questionario`,`x`.`gruppo_compilanti` AS `gruppo_compilanti`,`x`.`gruppo_valutati` AS `gruppo_valutati`,`x`.`autovalutazione` AS `autovalutazione`,`u`.`nome_utente` AS `nome_utente`,`u`.`funzione` AS `funzione`,`qc`.`progressivo_quest_comp` AS `progressivo_quest_comp`,`qc`.`stato` AS `stato_quest_comp`,`qc`.`data_compilazione` AS `data_compilazione` from ((((`progetti` `p` join `progetti_questionari` `x` on(`p`.`id_progetto` = `x`.`id_progetto`)) join `questionari` `q` on(`q`.`id_questionario` = `x`.`id_questionario`)) join `progetti_utenti` `u` on(`p`.`id_progetto` = `u`.`id_progetto`)) left join `questionari_compilati` `qc` on(`qc`.`id_progetto` = `x`.`id_progetto` and `qc`.`id_questionario` = `x`.`id_questionario` and `qc`.`utente_compilazione` = `u`.`nome_utente` and `qc`.`stato` in ('0','1'))) where `q`.`stato` = '1' and `p`.`stato` = '1' and `x`.`gruppo_compilanti` = `u`.`funzione` and (`qc`.`stato` is null or `qc`.`stato` = '0') ;
...
--
-- Struttura per vista `v_questionari_storici_per_utente`
--
DROP TABLE IF EXISTS `v_questionari_storici_per_utente`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_questionari_storici_per_utente`  AS  select `p`.`id_progetto` AS `id_progetto`,`p`.`titolo` AS `titolo_progetto`,`p`.`stato` AS `stato_progetto`,`q`.`id_questionario` AS `id_questionario`,`q`.`titolo` AS `titolo_questionario`,`q`.`stato` AS `stato_questionario`,`x`.`tipo_questionario` AS `tipo_questionario`,`x`.`gruppo_compilanti` AS `gruppo_compilanti`,`x`.`gruppo_valutati` AS `gruppo_valutati`,`x`.`autovalutazione` AS `autovalutazione`,`u`.`nome_utente` AS `nome_utente`,`u`.`funzione` AS `funzione`,`qc`.`progressivo_quest_comp` AS `progressivo_quest_comp`,`qc`.`stato` AS `stato_quest_comp`,`qc`.`data_compilazione` AS `data_compilazione` from ((((`progetti` `p` join `progetti_questionari` `x` on(`p`.`id_progetto` = `x`.`id_progetto`)) join `questionari` `q` on(`q`.`id_questionario` = `x`.`id_questionario`)) join `progetti_utenti` `u` on(`p`.`id_progetto` = `u`.`id_progetto`)) join `questionari_compilati` `qc` on(`qc`.`id_progetto` = `x`.`id_progetto` and `qc`.`id_questionario` = `x`.`id_questionario` and `qc`.`utente_compilazione` = `u`.`nome_utente`)) where `qc`.`stato` in ('1','2') and `x`.`gruppo_compilanti` = `u`.`funzione` ;
...
--
ALTER TABLE `progetti`
  MODIFY `id_progetto` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT per la tabella `questionari`
--
ALTER TABLE `questionari`
  MODIFY `id_questionario` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT per la tabella `questionari_compilati`
--
ALTER TABLE `questionari_compilati`
  MODIFY `progressivo_quest_comp` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
